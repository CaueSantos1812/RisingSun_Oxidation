...
#from sklearn.metrics import root_mean_squared_error -> Aparentemente o sklearn não tem esse método
...
#DEBUG STUFF, SHOULD BE DELETED AT SOME POINT
    ...
    def EXAFS_normalization(energies_array, absorption_array, debug=False):
        ...
        for npt in range(start_exafs, end_exafs):
            ...
            mse = mean_squared_error(data_y, fit_result.best_fit)
            rmse = np.sqrt(mse) #editado 06/09
